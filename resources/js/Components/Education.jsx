        ...
        <section id="education" className="portfolio-section">
            <div className="portfolio-container">
                ...
                <div className="portfolio-education">
                    <p className="portfolio-education__org">University of Science and Technology In Southern Philippines</p>
                    <p className="portfolio-education__course">Bachelor of Science in Information Technology – June 2018 – August 2022</p>
                    <ul className="portfolio-education__list">
                        <li>Capstone: Barangay Appointment Scheduler System with QR Code Scanner for user.</li>
                        <li>1st Honor Dean&apos;s Lister (2022) 4th Year</li>
                        <li>2nd Honor Dean&apos;s Lister (2021) 3rd Year</li>
                    </ul>
                    <p className="portfolio-education__org">Golden Heritage Institute</p>
                    <p className="portfolio-education__course">Professional Education Units (18 Units) – June 2025 – November 2025</p>
                </div>
